    ...
    public void onLoop() {
        ...
        if (ladder != null) {
            if (ChatDialog.getContinue() != null) {
                ...
                WebPath path = Traversal.getDefaultWeb().getPathBuilder().buildTo(ladder.getPosition());
                if (path != null) {
            ...
            if (!altar.isVisible()) {
                if (
                ...
                else if (Inventory.contains(379) ||
                        (Inventory.contains(5509) && Varbits.load(603).getValue() != 3) ||
                        (Inventory.contains(5510) && Varbits.load(604).getValue() != 6) ||
                        (Inventory.contains(5512) && Varbits.load(605).getValue() != 9) ||
                        (Inventory.contains(5513) && Varbits.load(605).getValue() != 7) ||
                    ...
                    if (Inventory.contains(5509) && Varbits.load(603).getValue() != 3)
                        Inventory.getItems(5509).first().interact("Fill");
                    if (Inventory.contains(5510) && Varbits.load(604).getValue() != 6)
                        Inventory.getItems(5510).first().interact("Fill");
                    if (Inventory.contains(5512) && Varbits.load(605).getValue() != 9)
                        Inventory.getItems(5512).first().interact("Fill");
                    if (Inventory.contains(5513) && Varbits.load(605).getValue() != 7)
                        Inventory.getItems(5513).first().interact("Fill");
                    if (Inventory.contains(5514) && Varbits.load(606).getValue() != 12)
                        Inventory.getItems(5514).first().interact("Fill");
                    if (Inventory.contains(379))
                        Inventory.getItems(379).first().interact("Eat");
                }
                else if (Players.getLocal().getTarget() == null && Players.getLocal().distanceTo(altar) < Players.getLocal().distanceTo(banker)) {
                    ...
                    if (Inventory.getSelectedItem() == null) {
                        ...
                        Player p = Players.newQuery().moving(true).filter(player -> player.getInteractionPoint().isVisible() && (player.getOrientationAsAngle() >= 270 || player.getOrientationAsAngle() == 0)).results().furthest();
                ...
                if (
                    (Inventory.contains(5509) && Varbits.load(603).getValue() != 0) ||
                    ...
                    if (Inventory.contains(5509) && Inventory.getEmptySlots() > 0 && Varbits.load(603).getValue() != 0)
                        Inventory.getItems(5509).first().click();
                    if (Inventory.contains(5510) && Inventory.getEmptySlots() > 0 && Varbits.load(604).getValue() != 0)
                        Inventory.getItems(5510).first().click();
                    if (Inventory.contains(5512) && Inventory.getEmptySlots() > 0 && Varbits.load(605).getValue() != 0)
                        Inventory.getItems(5512).first().click();
                    if (Inventory.contains(5513) && Inventory.getEmptySlots() > 0 && Varbits.load(605).getValue() != 0)
                        Inventory.getItems(5513).first().click();
                    if (Inventory.contains(5514) && Inventory.getEmptySlots() > 0 && Varbits.load(606).getValue() != 0)
